      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Общайся</h1>
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Простое общение для всех</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            <div className="p-4 border-b border-[#202225] flex items-center justify-between">
              <h2 className="text-white font-semibold text-base">Наше сообщество</h2>
              <Button
                variant="ghost"
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "знакомства", "юмор", "помощь"].map((channel) => (
                    <div
                      key={channel}
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Общая комната", "Посиделки"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Место для общения без лишних сложностей</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Общайся Бот</span>
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать!</strong> Это место, где можно просто поговорить с хорошими людьми.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что здесь можно делать:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>💬 Общаться в чате с живыми людьми</li>
                        <li>😊 Знакомиться и находить новых друзей</li>
                        <li>🎉 Делиться хорошим настроением и юмором</li>
                        <li>🎙️ Разговаривать голосом в комнатах</li>
                        <li>❤️ Быть собой — здесь всегда рады</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Привет всем! Рада быть здесь 😊 Как у вас дела?
                  </div>
                  ...
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg overflow-hidden w-full max-w-sm">
                      ...
                      <div className="absolute -bottom-3 sm:-bottom-4 left-3 sm:left-4">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-[#2f3136] bg-[#36393f] overflow-hidden relative">
                          <div className="w-full h-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
                            <span className="text-white text-2xl sm:text-3xl font-bold">А</span>
                          </div>
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      ...
                      <div className="mb-3 sm:mb-4">
                        <div className="bg-[#36393f] rounded-lg p-2 sm:p-3 relative">
                          ...
                          <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                            <span>😊</span>
                            <span>Люблю общаться с интересными людьми!</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">В сообществе с 2024</div>
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Активный участник</div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Серёжа</span>
                    <span className="text-[#72767d] text-xs hidden sm:inline">Сегодня в 12:08</span>
                  </div>
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Привет! Здесь всегда душевная атмосфера 🙌 Заходи почаще!
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Быстрая регистрация — займёт меньше минуты</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold text-sm sm:text-base">2</span>
                    </div>
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Выбери чат</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Зайди в любой канал и начни разговор</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Знакомься с людьми и находи новых друзей</p>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Никаких сложностей — зашёл и общаешься",
                    },
                    {
                      icon: <Smile className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Дружелюбное сообщество",
                      desc: "Добрая атмосфера и приятные люди",
                    },
                    {
                      icon: <Heart className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Для всех возрастов",
                      desc: "Подходит любому — от 18 до 80 лет",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Безопасно",
                      desc: "Модерация и защита от нежелательного контента",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Серёжа", status: "В сети", avatar: "С", color: "from-green-500 to-blue-500" },
                  { name: "Оля", status: "Слушает музыку", avatar: "О", color: "from-blue-500 to-purple-500" },
                ].map((user, index) => (
